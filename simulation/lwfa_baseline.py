"""
CPU baseline input for a laser-wakefield-acceleration simulation using FBPIC.

Upstream provenance
-------------------
This file is adapted from FBPIC's standard LWFA example:
https://fbpic.github.io/example_input/lwfa_script.html

The baseline parameters are retained from that example and use_cuda is
disabled for the laptop CPU run documented in this repository. FBPIC's
copyright and licence notice is retained in licenses/FBPIC-LICENSE.txt.

Usage
-----
- Run this file from the repository root.
- Type "python simulation/lwfa_baseline.py" in a terminal.
...
# (`python simulation/lwfa_baseline.py`), but not when importing it.
